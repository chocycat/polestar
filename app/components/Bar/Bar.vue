...
import { animate, createTimeline, type JSAnimation, spring, stagger } from "animejs";
...
<template>
  <div
    class="wrapper w-full h-100px perspective-1000px"
    @mouseenter="mouseEnter"
    @mouseleave="mouseLeave"
  >
    <div
      ref="bar"
      class="relative flex justify-between w-75% mx-auto h-full max-h-[50%] px-4 origin-top-center"
    >
      <div class="absolute top-0 left-0 flex justify-center w-full h-[80%]">
        ...
        />
        <div
          class="absolute mx-auto w-25% h-full bg-brand-background transform-origin-t"
        ></div>
      </div>

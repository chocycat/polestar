...
export class UnaryOpNode implements ASTNode {
  constructor(private op: string, private operand: ASTNode) {}
...
export class AngleNode implements ASTNode {
  constructor(private value: ASTNode, private mode: "deg" | "rad") {}
...
export class ValueWithUnitNode implements ASTNode {
  constructor(private value: ASTNode, private unit: UnitDef) {}
...
export class ConversionNode implements ASTNode {
  constructor(private value: ASTNode, private targetUnit: UnitDef) {}
...
export class RelativeDateNode implements ASTNode {
  constructor(private dayName: string, private weeksForward: number) {}
...
export class NextLastDayNode implements ASTNode {
  constructor(private direction: "next" | "last", private dayName: string) {}
